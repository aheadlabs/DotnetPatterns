...
//        private readonly Mock<ITypeAdapter<FakeDomainEntity, FakeEntity>> _domainToModelAdapterMock = new();
//        private readonly Mock<ITypeAdapter<FakeEntity, FakeDomainEntity>> _modelToDomainAdapterMock = new();
//        private readonly Mock<DomainServiceBase<DomainServiceBaseTests, FakeDomainEntity, FakeEntity, DbContextMock>> _sut;
//        private readonly Mock<ICrudService<DomainServiceBaseTests, FakeEntity, DbContextMock>> _crudServiceMock = new();
//        private readonly Mock<ILogger<DomainServiceBaseTests>> _loggerMock = new();
//        private readonly Mock<DbContextMock> _dbContextMock = new ();
...
//        // TODO: Adapt this tests to take into account the domain entities validations
...
//                entity2
//            };
//            Tuple<bool, FakeDomainEntity> result1 = Tuple.Create(true, entity1);
//            Tuple<bool, FakeDomainEntity> result2 = Tuple.Create(false, entity2);

//            // Setup the crudservice to return false with the entity2
//            Mock<ICrudService<DomainServiceBaseTests, FakeDomainEntity, DbContextMock>> crudServiceRelatedMock = new Mock<ICrudService<DomainServiceBaseTests, FakeDomainEntity, DbContextMock>>();
